...
const Home = () => {
  ...
  return (
    <>
      <Row>
        <Col md={2} className="opacity-50" style={{ height: "auto", marginTop:'105px', marginBottom:'5px',border: '0.5px solid gray', backgroundColor: '#F2F2F2'}}>
        ...
        {/* <Col md={1} className="h-100 align-items-left justify-content-center opacity-75" style={{ marginTop: "22%",border: '2px solid gray' }}>
          <strong class="bg-color-dark">DISCOVER </strong>
          <p>Your New Favorite Artist by Genre</p>
        </Col> */}
      </Row>
    </>
  );
